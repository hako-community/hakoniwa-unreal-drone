...
UCLASS()
class HAKONIWADRONE_API ADroneCameraActor : public AActor, public ICameraControllerInterface, public IHakoniwaObjectInterface
{
    GENERATED_BODY()
...
private:
    UPROPERTY()
    UPduManager* PduManager_ = nullptr;
