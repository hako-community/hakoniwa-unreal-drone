...
void AHakoniwaWebClient::Start_Implementation()
{
...
void AHakoniwaWebClient::Stop_Implementation()
{
...
void AHakoniwaWebClient::Reset_Implementation()
{
    // WebClient reset is not implemented yet
}