...
public class HakoniwaPdu : ModuleRules
{
	public HakoniwaPdu(ReadOnlyTargetRules Target) : base(Target)
	{
        ...
        {
            string LibPath = Path.Combine(ModuleDirectory, "../ThirdParty/shakoc/lib/Win64/shakoc.lib");
            PublicAdditionalLibraries.Add(LibPath);

            string DllPath = Path.Combine(ModuleDirectory, "../../../../Binaries/Win64/shakoc.dll");
